		...
		<div class="row">
			<div class="col-md-6">
				<form class="form-horizontal" action="../LoginServlet" method="post">
					<fieldset>
						<div id="legend">
							<legend class="">Carga Datos</legend>
						</div>
						
						<div class="control-group">
							<!-- Password-->
							<label class="control-label" for="password">Ruta archivo</label>
							<div class="controls">
								<input type="text" id="path" name="txtPath"
									placeholder="" class="input-xlarge">
							</div>
						</div>						
						<div class="control-group">
							<label class="control-label" for="username">tipo carga</label>							
							<div class="controls" style="width: 166px; ">
					            <select class="form-control" name="txtTipoCarga" contenteditable="false"  style="width: 177px; ">
					               <option value="">Seleccione tipo</option>
					               <option value="cargaUsuario">usuarios</option>
					               <option value="juegos">juegos</option>
					               <option value="naves">naves</option>
					               <option value="juegoActual">juego actual</option>
					            </select>
					        </div>
						</div>
						<div class="control-group">
							<div class="controls">
								<p class="help-block">
									<% String resultadoCarga = (String)session.getAttribute("resultadoCarga"); %>
									<%= resultadoCarga %>	
						...
						<div class="control-group">						
							<div class="controls">								
								<input type="hidden" name="action" value="cargaDatos">
