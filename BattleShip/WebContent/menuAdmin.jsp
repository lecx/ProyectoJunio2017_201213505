		...
		<div class="container">		
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li><a href="funcionesAdmin/GestionUsuarios.jsp">Gestion Usuario</a></li>
					<li><a href="funcionesAdmin/GestionJuegos.jsp">Gestion Juegos</a></li>
					<li><a href="funcionesAdmin/CargarDatos.jsp">Carga Datos</a></li>
					<li><a href="funcionesAdmin/Reportes.jsp">Reportes</a></li>
